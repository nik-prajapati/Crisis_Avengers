    ...
    <>
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),url(${
              process.env.PUBLIC_URL + "images/Disaster-Management.jpg"
            })`,
      ...
      <div id="cont2" className="govtcontainer ">
            ...
            <div className="rightSide">
             <img src={process.env.PUBLIC_URL + "images/indiamap.png"}></img>
            </div>
         </div>
      </div>
      ...
      <div  className="govtcontainer ">
            ...
            <div className="rightSide">
             <img className="rescueimg" src ={process.env.PUBLIC_URL + "images/rescue.png"}></img>
            </div>
